...
../cmd/sequential/mrsequential ../plugins/wc/wc.so ../test/testdata/pg*txt || exit 1
...
$TIMEOUT ../cmd/worker/mrworker ../plugins/wc/wc.so &
$TIMEOUT ../cmd/worker/mrworker ../plugins/wc/wc.so
$TIMEOUT ../cmd/worker/mrworker ../plugins/wc/wc.so &
$TIMEOUT ../cmd/worker/mrworker ../plugins/wc/wc.so
...
# generate the correct output
../cmd/sequential/mrsequential ../plugins/indexer/indexer.so ../test/testdata/pg*txt || exit 1
...
# start multiple workers
$TIMEOUT ../cmd/worker/mrworker ../plugins/indexer/indexer.so &
$TIMEOUT ../cmd/worker/mrworker ../plugins/indexer/indexer.so
...
$TIMEOUT ../cmd/worker/mrworker ../plugins/jobcount/jobcount.so &
$TIMEOUT ../cmd/worker/mrworker ../plugins/jobcount/jobcount.so
$TIMEOUT ../cmd/worker/mrworker ../plugins/jobcount/jobcount.so &
$TIMEOUT ../cmd/worker/mrworker ../plugins/jobcount/jobcount.so
...
($TIMEOUT ../cmd/coordinator/mrcoordinator ../test/testdata/pg*txt ; touch $DF) &

# give the coordinator time to create the sockets.
sleep 1

# start multiple workers.
($TIMEOUT ../cmd/worker/mrworker ../plugins/early_exit/early_exit.so; touch $DF) &
($TIMEOUT ../cmd/worker/mrworker ../plugins/early_exit/early_exit.so; touch $DF) &
($TIMEOUT ../cmd/worker/mrworker ../plugins/early_exit/early_exit.so ; touch $DF) &
...
# generate the correct output
../cmd/sequential/mrsequential ../plugins/nocrash/nocrash.so ../test/testdata/pg*txt || exit 1
sort mr-out-0 > mr-correct-crash.txt
rm -f mr-out*

rm -f mr-done
($TIMEOUT ../cmd/coordinator/mrcoordinator ../test/testdata/pg*txt ; touch mr-done)&
sleep 1

# start multiple workers
$TIMEOUT ../cmd/worker/mrworker ../plugins/crash/crash.so &
